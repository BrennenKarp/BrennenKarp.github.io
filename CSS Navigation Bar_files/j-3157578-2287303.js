...
(function(){
    ...
    (function() {
    var p = "3157578", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3157578||'',
    GUID:window.ftGUID_3157578||'99999999999',
    confID:window.ftConfID_3157578||'0',
    ftReturn: window.ftReturn_3157578||'',
    keyword:window.ftKeyword_3157578||'',
    ftId:window.ftId_3157578||'',
    imp:window.ftImp3157578,
    ftImpId:window.ftImp3157578 && window.ftImp3157578.impID || '',
    campaignID:'84842',
    cID:'91996',
    pID:'3157578',
    creativeID:'2287303',
    exttrack:["https://ad.doubleclick.net/ddm/ad/N5823.Turn/B20681036.220156395;sz=1x1;u=BidID[value];ord=[timestamp];dc_lat=;dc_rdid=;tag_for_child_directed_treatment=?"],
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/3/84842;3157578;2287303;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://ad.doubleclick.net/ddm/clk/418560376;220156395;i?http://store.hp.com?jumpid=ba_con_nc_np&utm_medium=ba&utm_source=tn","http://servedby.flashtalking.com/click/3/84842;3157578;2287303;212;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://ad.doubleclick.net/ddm/clk/418560376;220156395;i?http://store.hp.com","http://servedby.flashtalking.com/click/3/84842;3157578;2287303;213;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://ad.doubleclick.net/ddm/clk/418560376;220156395;i?http://store.hp.com","http://servedby.flashtalking.com/click/3/84842;3157578;2287303;214;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://clickTag4.com","http://servedby.flashtalking.com/click/3/84842;3157578;2287303;215;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://clickTag5.com","http://servedby.flashtalking.com/click/3/84842;3157578;2287303;216;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://clickTag6.com","http://servedby.flashtalking.com/click/3/84842;3157578;2287303;217;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://clickTag7.com","http://servedby.flashtalking.com/click/3/84842;3157578;2287303;218;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://clickTag8.com","http://servedby.flashtalking.com/click/3/84842;3157578;2287303;219;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://clickTag9.com"],
    placementDescription:'WP3rdCPSTest6Turn020118103118300x250DBhvIntel',
    width:300,
    height:250,
    ...
    divID:'ftdiv3157578',
    phID:'ftpos3157578',
    frameID:'ftframe3157578',
    expID:'ftexpframe3157578',
    altImgID:'ftalt3157578',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/3/84842;3157578;2287303;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://ad.doubleclick.net/ddm/clk/418560376;220156395;i?http://store.hp.com?jumpid=ba_con_nc_np&utm_medium=ba&utm_source=tn',
    altImg:'http://servedby.flashtalking.com/imp/3/84842;3157578;204;gif;TurnUS;WP3rdCPSTest6Turn020118103118300x250DBhvIntel/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/3/84842;3157578;271;pixel;TurnUS;WP3rdCPSTest6Turn020118103118300x250DBhvIntel/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/315/3157578/2287303/js/j-3157578-2287303.js',
    file:'http://cdn.flashtalking.com/91996/2287303/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?115348100-3157578;2287303;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_3157578||'',
    segmentList:window.ftSegmentList_3157578||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3157578 && window.ftImp3157578.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3157578')&&/^https:/.test(document.getElementById('ftscript_m3157578').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3157578'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3157578'],
        ['ftcfid', 'ftConfID_3157578'],
        ['fttime', 'ftTimestamp_3157578'],
        ['ftsection', 'ftSection_3157578'],
        ['ftcustom', 'ftCustom_3157578'],
        ['ft_id', 'ftId_3157578'],
        ['ftimpid','ftImp3157578', 'impID']
    ]
};
...
(function(o) {
    try {
        var dcmCId, dcmPID, hold, linkToUrl;
        if (o.exttrack[0].indexOf("ad.doubleclick") > -1) {
            hold = o.exttrack[0].slice(o.exttrack[0].lastIndexOf("/")).split(".");
            dcmCId = hold[0].slice(1);
            if(dcmCId.indexOf("B")==0){
                dcmCId = dcmCId.slice(1);
            }
            dcmPID = hold[1].split(";")[0];

            //add specific site url here
            linkToUrl = "//linkto.ext.hp.com/i/365223/342132/5105?adcampaign=HP-PHD-US_Q2_FY18_HPCOM_HPStore_HHO_HomeandHomeOffice_OMG&adplacement=W_P_3rdCPSTest6Turn_020118-103118_300x250_D_Bhv_Intel&subId2=FT";
            linkToUrl = linkToUrl.replace("HP-PHD-US_Q2_FY18_HPCOM_HPStore_HHO_HomeandHomeOffice_OMG", dcmCId);
            linkToUrl = linkToUrl.replace("W_P_3rdCPSTest6Turn_020118-103118_300x250_D_Bhv_Intel", dcmPID);
         
            new Image().src = linkToUrl;
        }
        if(o.clickTags[0].indexOf("?jumpid") > -1){
            o.clickTags[0] = o.clickTags[0] + "&utm_campaign="+ dcmCId+ "&adplacement=" + dcmPID;
        }
    } catch (e) {}
...
//ftMinified
//Sets css of OBA adChoices icon to left if ad height is 728 or 90 only
ft3157578.addEventListener("start",function(){
!function(){var a=ft3157578,b=a.iframe?window.parent:window,c=b.document.getElementById(a.divholder?a.divholder:a.divID),d="https://support.google.com/adsense/troubleshooter/1631343",e=2,f=512,g=360,h="http://cdn.flashtalking.com/oba/icon/iconc.png?EDAA_icon=y",i="en",j=72,k="";if(1==a.qs("ftOBA",0)){var l=function(){for(var a=(navigator.language?navigator.language:navigator.userLanguage).toLowerCase().substr(0,2),b=[{c:"bg",w:89},{c:"cs",w:84},{c:"da",w:81},{c:"de",w:93},{c:"el",w:105},{c:"en",w:72},{c:"es",w:99},{c:"fi",w:73},{c:"fr",w:86},{c:"it",w:62},{c:"nl",w:102},{c:"pl",w:69},{c:"ro",w:53},{c:"sk",w:72},{c:"sv",w:72}],c=b.length;c--;)if(a==b[c].c){i=b[c].c,j=b[c].w;break}k="http://cdn.flashtalking.com/oba/icon/icone_"+i+".png?EDAA_icon=y"},m=function(){function b(b){return a.secure&&(b=b.replace(/\bhttp:\/\/(cdn(?=\.flash)|video(?=\.flash)|stat(?=\.flash)|a(?=\.flash))/,"https://secure"),b=b.replace("http:","https:")),b}h=b(h),k=b(k)},n=function(){l(),m();var i=b.document.createElement("div");i.id="ftAdChoices_"+a.pID,icon1=b.document.createElement("img"),icon2=b.document.createElement("img"),link=b.document.createElement("a"),icon1.src=h,icon1.id="button",icon1.style.cssText="border:0; width:19px; height:15px;",icon2.style.cssText="border:0; display:none; width:"+j+"px; height:15px;",icon2.id="expButton",i.style.cssText = (a.height == 90||a.height==250) ? "position:absolute; top:1px; left:2px" : "position:absolute; top:1px; right:2px",i.style.zIndex=c.style.zIndex||"auto",i.appendChild(link),link.appendChild(icon1),link.appendChild(icon2),c.appendChild(i),i.onmouseover=function(){icon1.style.display="none",icon2.src=k,icon2.style.display="inline"},i.onmouseout=function(){icon2.style.display="none",icon1.style.display="inline"},2==e?(link.onclick=function(){window.open(d,"adchoicesinterstitial","height="+g+",width="+f+",position=0, directories=0, menubar=0")},link.style.cursor="hand"):(link.target="_blank",link.href=d),a.dispatchEvent("obaEnd")};null!=c?n():a.addEventListener(a.swf||a.file?"adonpage":"backup",function(){var d=function(){c=b.document.getElementById(a.divholder?a.divholder:a.divID),null!=c?n():setTimeout(d,200)};d()})}}(),b3f56725e=!0;
});
